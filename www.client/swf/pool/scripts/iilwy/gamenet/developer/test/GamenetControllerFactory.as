package iilwy.gamenet.developer.test
{
   ...
   public class GamenetControllerFactory
   {
      ...
      public static function createTest(param1:int = 7, spectator:Boolean = false) : GamenetController
      {
        ...
        // game_controller.setSyncedTime(ExternalInterface.call("swf.startTime",""));
