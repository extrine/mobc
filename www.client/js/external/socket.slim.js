				...
				;(e.deconstructPacket = function (t) {
					...
					(e.removeBlobs = function (t, e) {
						function r(t, a, p) {
							...
							else if ('object' == typeof t && !s(t)) for (var l in t) r(t[l], l, t)
						}
						var n = 0,
							o = t
						r(o), n || e(o)
		...
		function (t, e, r) {
			...
			;(t.exports = n),
				...
				(n.prototype.onopen = function () {
					...
					var t = this.engine
					this.subs.push(h(t, 'data', p(this, 'ondata'))),
						this.subs.push(h(t, 'ping', p(this, 'onping'))),
						this.subs.push(h(t, 'pong', p(this, 'onpong'))),
						this.subs.push(h(t, 'error', p(this, 'onerror'))),
						this.subs.push(h(t, 'close', p(this, 'onclose'))),
						this.subs.push(h(this.decoder, 'decoded', p(this, 'ondecoded')))
				}),
						...
						var r = setTimeout(function () {
							t.skipReconnect ||
								...
								t.skipReconnect ||
									t.open(function (e) {
										e
											? ((t.reconnecting = !1), t.reconnect(), t.emitAll('reconnect_error', e.data))
											: t.onreconnect()
									}))
						}, e)
						this.subs.push({
			...
			;(function (e) {
				function n(t, r) {
					...
					;(r = r || {}),
						...
						(this.secure =
							null != r.secure ? r.secure : e.location && 'https:' === location.protocol),
						...
						(this.port =
							r.port || (e.location && location.port ? location.port : this.secure ? 443 : 80)),
						(this.query = r.query || {}),
				...
				;(t.exports = n),
					...
					(n.prototype.onHeartbeat = function (t) {
						...
						e.pingTimeoutTimer = setTimeout(function () {
							'closed' !== e.readyState && console.log('ping timeout!') && e.onClose('ping timeout')
		...
		function (t, e, r) {
			;(function (t) {
				...
				;(e.encodePacket = function (e, r, i, a) {
					...
					return (
						void 0 !== e.data &&
							(h += i ? d.encode(String(e.data), { strict: !1 }) : String(e.data)),
						a('' + h)
					)
				}),
					(e.encodeBase64Packet = function (r, n) {
						...
						try {
							...
							for (
								var a = new Uint8Array(r.data), c = new Array(a.length), h = 0;
								h < a.length;
								h++
							)
								c[h] = a[h]
					...
					(e.decodePayload = function (t, r, n) {
						...
						for (var i, s, a = '', c = 0, h = t.length; c < h; c++) {
							...
							if (':' === p) {
								...
								if (s.length) {
									if (((o = e.decodePacket(s, r, !1)), k.type === o.type && k.data === o.data))
										return n(k, 0, 1)
									var u = n(o, c + i, h)
									if (!1 === u) return
								}
				...
				!(function (i) {
					...
					function a(t) {
						for (var e, r = t.length, n = -1, o = ''; ++n < r; )
							(e = t[n]),
								e > 65535 &&
									((e -= 65536), (o += k(((e >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
								(o += k(e))
						return o
					}
					function c(t, e) {
					...
					function p(t, e) {
						...
						return (
							0 == (4294965248 & t)
								? (r = k(((t >> 6) & 31) | 192))
								: 0 == (4294901760 & t)
								? (c(t, e) || (t = 65533), (r = k(((t >> 12) & 15) | 224)), (r += h(t, 6)))
								: 0 == (4292870144 & t) &&
								  ((r = k(((t >> 18) & 7) | 240)), (r += h(t, 12)), (r += h(t, 6))),
							(r += k((63 & t) | 128))
						)
					}
					function u(t, e) {
						e = e || {}
						for (var r, n = !1 !== e.strict, o = s(t), i = o.length, a = -1, c = ''; ++a < i; )
							(r = o[a]), (c += p(r, n))
						return c
					}
					function f() {
					...
					function l(t) {
						...
						if (224 == (240 & e)) {
							if (((r = f()), (n = f()), (i = ((15 & e) << 12) | (r << 6) | n), i >= 2048))
			...
			;(function (e) {
				function n(t) {
					...
					e && (this.supportsBinary = !1),
						...
						this.usingBrowserWebSocket || (u = o),
						i.call(this, t)
				}
				var o,
					i = r(17),
			...
			s(n.prototype),
				(n.prototype.subEvents = function () {
					if (!this.subs) {
						var t = this.io
						this.subs = [
							c(t, 'open', h(this, 'onopen')),
							c(t, 'packet', h(this, 'onpacket')),
							c(t, 'close', h(this, 'onclose')),
						]
					}
				}),
