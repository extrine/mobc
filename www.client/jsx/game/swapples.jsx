var GameSwapples = React.createClass({
	mixins: [React.addons.PureRenderMixin],

	getInitialState: function () {
		window.swf = this
		if (window.user.fswap && window.room.id.indexOf('swapples-nof') !== 0) {
			this.url = 'swf/swapples/game.swf?48'
		} else {
			this.url = 'swf/swapples-original/game.swf?48'
		}
