var GameGemmers = React.createClass({
	mixins: [React.addons.PureRenderMixin],

	getInitialState: function () {
		window.swf = this
		this.url = 'swf/gemmers/game.swf?17'
		u.download(
			this.url,
			function (percent) {
				if (percent == 100) {
	...
	render: function () {
		return (
			<div className="game-swf">
				...
				{this.state.loaded === true && this.props.room.started && !this.meRoom().spectator ? (
					<div className="game-swf-object">
						<GameGemmersScores room={this.props.room} data={this.props.data} />
	...
	background_image: function () {
		return 'https://omgmobc.com/img/background/games-jewels-readybg.jpg'
	},
